...
type WebServerRouteConfig struct {
	// The URL path for the route
	Path string `pkl:"path"`

	// Optional port for the application. Only applicable if serverType is "app". (default: 8052)
	...
	// Public path relative to the agent directory (default: "/data/web/")
